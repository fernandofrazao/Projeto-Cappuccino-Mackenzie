...
<header>
	...
	h5{text-align: center; padding-top: 0px; color: #FFF;}
	...
	div#menu{width: 300px; height: 220px;display: block; margin: auto; border: none; border-radius: 5px; background-color: #007fff; text-align: center;}
	...
	div.pub{width: 400px; min-height: 70px; max-height: 1000px; display: block; margin: auto; border: none; border-radius: 5px; background-color: #FFF; box-shadow: 0 0 6px #A1A1A1; margin-top: 150px;}
...
<body>
	...
	<div id="menu">
		...
		<div id="menu">
			<br>
			<h5> <strong> Email: </strong> <?php echo $saber['email']; ?> </h5> <br />
			<h5> <strong> Cidade: </strong>  <?php echo " ". $saber['cidade']; ?> </h5> <br />
			<h5> <strong> Estado: </strong>  <?php echo " ".$saber['estado']; ?></h5><br />
			<h5> <strong> Data de nascimento: </strong> <?php echo " ".$saber['data']; ?></h5><br />
			<h5> <strong> Preferencia: </strong> <?php echo " ".$saber['preferencia']; ?></h5><br />
	</div>
	</div>
	<?php
